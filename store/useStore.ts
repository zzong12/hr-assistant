...
interface AppActions {
  ...
  setUIPreferences: (preferences: Partial<Pick<UIState, "currentModule">> & { isSidebarCollapsed?: boolean }) => void;
...
export const useStore = create<AppState & AppActions>()((set) => ({
  ...
  setConversations: (conversations) =>
    set((state) => ({
      ...
      currentConversation: state.currentConversation
        ? conversations.find((c) => c.id === state.currentConversation?.id) || null
        : null,
    })),
  ...
  setUIPreferences: (preferences) =>
    set((state) => ({
      ...state,
      ...(preferences.currentModule ? { currentModule: preferences.currentModule } : {}),
      ...(typeof preferences.isSidebarCollapsed === "boolean"
